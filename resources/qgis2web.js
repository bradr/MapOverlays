...
map.getView().fit([-12704194, 6625317, -12692152, 6634491], map.getSize());   //49.84524946138526, -119.58576731817884
//map.getView().fit([-119.557, 49.8452, -119.5857, 49.9452], map.getSize());
